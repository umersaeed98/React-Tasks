...
import styles from './ServicesSecondDetails.module.scss'
...
const ServicesSecondDetails = () => {
  ...
  return (
    ...
    <Container fluid>
      <Row>
        <Col lg={9} md={12} sm={12} xs={12} className={`${styles.servicessecondDetailsContainer}`}>
        <ServicesReuse
...
<ul className={`${styles.unorderedListServices}`}>
    ...
    <Container fluid>
            ...
            <Col lg={6} sm={12} xs={12} md={12} className={` text-center py-3  px-4 gx-0 ${styles.quote}`}>
           <Link to='/contact'>
           <Buttons 
            color='white'
            ...
            <Col lg={6}  md={12} xs={12} sm={12} className={` text-center  py-3 px-4 ${styles.onlineForm}`}>
            <Link to='/project'>
            <Buttons 
            color='white'
...
export default ServicesSecondDetails
